...
<h1 align="center">Reporte de Visitas</h1>
            ...
            <table id="listaD" class="table table-bordered text-center table-striped tablesorter" border="1">
                ...
                <tr>
                    <td>
                        ...
                        <form action="MesVisitas.php" method="post">
                            <input type="month" name="Fecha2" id="Fecha2">
                            <input style='display:none;' class="hidden" name="rol" value="<?php echo $Matricula2; ?>"
                                   id="rol"/>
                            <input style='display:none;' class="hidden" name="matricula"
                                   value="<?php echo $Matricula; ?>" id="matricula"/>
                ...
                <tr>
                    <td>
                        <form action="DiaVisitas.php" method="post">
